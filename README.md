...
| `git remote remove origin` | Remove remote origin from git repository |
| `git remote set-url origin [git://new.url.here]` | Remove exiting remote origin and add new remote origin |
